...
const Hero = () => {
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 h-full`}>
      ...
      <div className='flex flex-row justify-between items-center w-full'>
          ...
          <div className='ss:flex hidden md:mr-4 mr-2 md:ml-16'>
            <GetStarted/>
          </div>
      </div>
      ...
      <div>
        ...
        <div className='absolute z-[0] w-[80%] h-[80%] top-0 rounded-full white__gradient'/>
        <div className='absolute z-[0] w-[50%] h-[50%] right-20 top-0 blue__gradient'/>
      </div>
