...
const Testimonials = () => {
  ...
  ${styles.flexCenter} flex-col relative ml-8`}>
    <div className='absolute z-[0] w-[60%] h-[60%] -right-[50%] rounded-full blue__gradient'></div>
    <div className='w-full flex justify-between items-center
    md:flex-row flex-col sm:mb-16 mb-6 ml-8 relative'> 
      <h2 className={`${styles.heading2}`}>
        <br className='sm:block hidden'/> 
        What people are saying about us
      </h2>
      <div className='w-full md:mt-0 mt-6 ml-8'>
      <p className={`${styles.paragraph} text-left max-w-[470px] mt-5`}>With the right credit card, 
